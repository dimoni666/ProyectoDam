...
<tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="tx_nombre" id="tx_nombre" value='<?php echo $str_nombre ?>' size="30"  maxlength="10" />
        </td>
    </tr>
    <tr>
        <td><label for="tx_apPaterno">Primer Apellido</label></td>
        <td>
            <input type="text" name="tx_apPaterno" id="tx_apPaterno" value='<?php echo $str_apPaterno ?>' size="30"  maxlength="15" />
        </td>
    </tr>
    <tr>
        <td><label for="tx_apMaterno">Segundo Apellido </label></td>
        <td>
            <input type="text" name="tx_apMaterno" id="tx_apMaterno"  value='<?php echo $str_apMaterno ?>' size="30"  maxlength="15" />
        </td>
    </tr>
    <tr>
        <td><label for="tx_correo">Correo electronico</label></td>
        <td>
            <input type="text" name="tx_correo" id="tx_correo"  value='<?php echo $str_correo ?>' size="30"  maxlength="50" />
        </td>
    </tr>
    <tr>
        <td><label for="tx_username">Nombre de usuario</label></td>
        <td>
            <input type="text" name="tx_username" id="tx_username"  value='<?php echo $str_username ?>' size="25"  maxlength="10"  />
        </td>
    </tr>
    <tr>
        <td><label for="tx_password">Contrase&ntilde;a</label></td>
        <td>
            <input type="password" name="tx_password" id="tx_password"  value='<?php echo $str_password ?>'  size="25"  maxlength="15" />
        </td>
    </tr>
    <tr>
        <td><label for="tx_password2">Confirme la contrase&ntilde;a</label></td>
        <td>
            <input type="password" name="tx_password2" id="tx_password2"  value='<?php echo $str_password2 ?>'  size="25"  maxlength="15" />
        </td>
    </tr>
