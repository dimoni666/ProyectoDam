...
if( isset( $_POST['correo'] ) && $_POST['correo'] != '' )
{
    ...
    $sql = "SELECT  id,nickname,tnombre,apellido
            FROM usuarios
            WHERE mail = '".$elcorreo."'";         
...
<?php
    ...
    $idusr  = $fila->id;     //Servira para actualizar el pw
...
"*","]","[","_",":",";","+");
    ...
    // Le  Envio  por correo electronico  su nuevo password 
     ...
     $nomAdmin          = 'Jaume Jimenez';       //Quien envia
     $mailAdmin         = 'dimoni666@gmail.com';   //Mail de quien envia
    ...
    if(mail($destinatario,$asunto,$cuerpomsg,$cabeceras))
    {
        ...
        $sql_updt = "UPDATE usuarios SET password = '".md5($pasw)."' 
        WHERE (id = ".$idusr.")
        AND ( mail = '".$elcorreo."')";
